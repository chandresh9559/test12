                  ...
                  <tbody>
                   ...
                   <?php echo $this->Html->link(__('Click'), ['controller' => 'users', 'action' => 'approv','prefix'=>'Admin',$user->id], ['class' => 'nav-link text-dark']);?>
                    ...
                    <td>
                      <?php
                      if($user->status == 1){
                          echo $this->Html->link(__('Inactive'), ['controller' => 'users','prefix'=>'Admin','action' => 'activeInactive', $user->id],['confirm'=>'Are you sure you want to Inactive account']);
                        }else{
                          echo $this->Html->link(__('Active'), ['controller' => 'users','prefix'=>'Admin','action' => 'activeInactive', $user->id],);
                        }
                        ?>
                    </td>
