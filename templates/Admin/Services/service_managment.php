                    ...
                    <div class="d-flex align-items-center justify-content-center">
                      ...
                      <span class="me-2 text-xs font-weight-bold">
                        ...
                        if ($service->service_status == 1) {
                          echo $this->Html->link(__(''), ['controller' => 'Services', 'prefix' => 'Admin', 'action' => 'deleteRecoverService', $service->id], ['class' => 'fa-solid fa-recycle recycle', 'id' => 'recycle', 'data-id' => $service->id]);
                        } else {
                          echo $this->Html->link(__(''), ['controller' => 'Services', 'prefix' => 'Admin', 'action' => 'deleteRecoverService', $service->id], ['class' => 'fa-sharp fa-solid fa-trash delete', 'id' => 'delete', 'data-id' => $service->id]);
                        }
                        ?>
                      </span>
                      <div>
