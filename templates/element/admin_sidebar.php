    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <?php echo $this->Html->link('<i class="fa fa-check-to-slot" ></i>' . __('Assign Project'), ['controller' => 'Projects', 'action' => 'serviceManagment','prefix'=>'Admin'], ['escape' => false, 'class' => 'nav-link text-light users']) ?>  
